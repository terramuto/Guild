...
v30은 나이 진행도 함께 지원합니다. 게임 30일을 1년으로 계산해 은퇴 기준 60세, 55세 경고를 적용하고, 은퇴한 용병은 파티에서 빠져 길드 기록의 은퇴 명단으로 보관됩니다.


v31에서는 용병 개인 소비를 길드 자금과 완전히 분리했습니다. 숙박·음식·훈련·전직·수리·장비·소모품은 해당 용병 보유금에서만 결제되며 길드 자금은 변하지 않습니다. [v31 개인 자금 분리](V31.md)


v32에서는 길드 내부 탭에 자금 장부를 추가했습니다. 시설 유지비·확장·제작·모집과 의뢰 수수료 수입을 발생 시각, 증감액, 거래 후 잔액과 함께 저장합니다. [v32 길드 자금 장부](V32.md)

...
v20에서 용병 전투 모션 20프레임을 추가했고, v21에서 해당 원본을 기반으로 36개 직업 전용 모션 행을 구성했습니다. v22에서는 직업마다 다른 캐릭터 이미지와 새 길드 내부 배경을 추가했습니다. [v20 용병 전투 모션 제작 기록](V20.md) · [v21 36직업 모션 기록](V21.md) · [v22 직업별 모션·길드 내부](V22.md)

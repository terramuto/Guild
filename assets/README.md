...
| 파일 | 구성 | 게임에서 사용 |
|---|---|---|
| [bosses-v18.png](bosses-v18.png) | 투명 5×5, 네임드 25종 | named-0~named-24 순서. 일반 교전에는 일부 외형을 재사용 |
| [backgrounds-v18.png](backgrounds-v18.png) | 2×3, 배경 6종 | 숲·상단길·광산·폐허·성소·화산 |
| [weapons-v18.png](weapons-v18.png) | 투명 5×4, 무기 20종 | 3차 직업별 외형. 하위 직업은 계열에 맞는 외형 사용 |
